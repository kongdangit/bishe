...
<head>
    ...
    {
	   margin-left: 0px;
	   background: url(<%=path %>/images/bhj.jpg) no-repeat;
    }
    .style2 {color: #990000}
    .input2 
    {
    ...
    .STYLE15 {color: #fdsere; font-size: 20pt; }
    .td_title{
    	FONT-WEIGHT: bold; 
    	FONT-SIZE: 48pt;
    	font-family:"华文行楷";
...
<body class="bodys">
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"> 
	 <tr>
	    <td class="td_title"><div align="center">农产品交易系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="center" cellpadding="0" cellspacing="0">
			        ...
			        <tr>
					    <td width="40" height="35" valign="bottom" >
						    <span class="STYLE15" style="white-space: nowrap;">用户名：  </span>
						</td>
					...
					<tr>
						<td width="40" height="35" colspan="2" valign="top" class="STYLE15">
						     密&nbsp;码：
							<input name="userPw" type="password" size="20" class="input2" align="bottom" onMouseOver="this.style.background='#F0DAF3';" onMouseOut="this.style.background='#FFFFFF'">
						</td>
					</tr>
					<tr>
						<td height="10" colspan="2" valign="bottom"></td>
